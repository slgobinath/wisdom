...
@lexer::members {
  ...
  public Token nextToken() {
    ...
    if (_input.LA(1) == EOF && !this.indents.isEmpty()) {
      ...
      this.emit(commonToken(WisdomQLParser.NEWLINE, "\n"));
      ...
      this.emit(commonToken(WisdomQLParser.EOF, "<EOF>"));
    }
  ...
  private Token createDedent() {
    CommonToken dedent = commonToken(WisdomQLParser.DEDENT, "");
...
wisdom_app
    : annotation? definition (END_OF_STATEMENT definition)* END_OF_STATEMENT query (END_OF_STATEMENT query)*
    END_OF_STATEMENT?
    ;
