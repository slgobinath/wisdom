...
public class ExternalIdleTimeBatchWindowTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(ExternalIdleTimeBatchWindowTest.class);
    ...
    public void testWindow1() throws InterruptedException {
        ...
        wisdomApp.defineQuery("query1")
                .from("StockStream")
                .window(Window.externalIdleTimeBatch("timestamp", Duration.ofSeconds(1)))
                .select("symbol", "price")
