...
public class PcapFileSource extends Source {
        ...
        if (handle != null) {
            ...
            while (true) {
                ...
                try {
                    ...
                    Map<String, Comparable> networkPacket = extractIcmpPacket(handle, packet);
    ...
    private static Map<String, Comparable> extractTcpPacket(PcapHandle handle, Packet packet) {
        ...
        Map<String, Comparable> networkPacket = new HashMap<>();
    ...
    private static Map<String, Comparable> extractUdpPacket(PcapHandle handle, Packet packet) {
    ...
    private static Map<String, Comparable> extractIcmpPacket(PcapHandle handle, Packet packet) {
