...
public class UniqueExternalTimeBatchWindowTest {
    ...
    public void testWindow1() throws InterruptedException {
        ...
        callbackUtil.addCallback(wisdomApp,
                TestUtil.map("ip", "192.10.1.4", "timestamp", 1366335804342L, "count", 2L),
                TestUtil.map("ip", "192.10.1.4", "timestamp", 1366335805341L, "count", 1L),
                TestUtil.map("ip", "192.10.1.6", "timestamp", 1366335814345L, "count", 2L));
    ...
    public void testWindow2() throws InterruptedException {
        ...
        callbackUtil.addCallback(wisdomApp,
                TestUtil.map("ip", "192.10.1.4", "timestamp", 1366335805340L, "count", 2L),
                TestUtil.map("ip", "192.10.1.6", "timestamp", 1366335814545L, "count", 2L));
